...
String bestProductList = (String) request.getAttribute("product-best");
String newProductList = (String) request.getAttribute("product-new");


////////////////////////////////////////////////////////////////////////
RequestDispatcher rd = null;

/* if(bestProductList == null || newProductList == null){
	rd = request.getRequestDispatcher("/main"); // IndexServlet
	rd.include(request, response);
	
	bestProductList = (String) request.getAttribute("product-best");
	newProductList = (String) request.getAttribute("product-new");
} */

/* OR */
if(bestProductList == null){
	rd = request.getRequestDispatcher("/product/best"); // product-list-best-sevlet
	rd.forward(request, response);
	bestProductList = (String) request.getAttribute("product-best");
}
if(newProductList == null){
	rd = request.getRequestDispatcher("/product/new"); // product-list-new-servlet
	rd.forward(request, response);
	newProductList = (String) request.getAttribute("product-new");
} 
...
<html lang="ko">
    ...
    <body>
        ...
        <section class="decoSection2">
        </section>
        
        <footer-component></footer-component>

        <script type="text/javascript" src="/ootm/javascript/index.js"></script>
        <script type="text/javascript" src="/ootm/component/carousel/carousel.js"></script>
        <script type="text/javascript" src="/ootm/component/hoverbox/hoverbox.js"></script>
        <script type="text/javascript" src="/ootm/component/footer/footer.js"></script>
    </body>
