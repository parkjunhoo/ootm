...
<html lang="ko">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/ootm/css/search.css"/>
    ...
    <body>
        ...
        <section id="searchResultSection">
            <div class="searchPageOuter">
                <form action="" id="searchPageForm" name="searchPageForm">
                    <h1>#</h1>
                    <input type="text" id="searchPageInput" name="searchPageInput"/>
                ...
                <div id="searchResultDiv">
                    ...
                    <span onclick="focusToSearchBar()" class="anotherSearch">다른 검색어로 찾기</span>
